...
namespace DentAssist.Controllers
{
    public class OdontologosController : Controller
    {
        ...
        {
            return View(await _context.odontologo.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Matricula,Email,EspecialidadId,UsuarioId")] Odontologo odontologo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Matricula,Email,EspecialidadId,UsuarioId")] Odontologo odontologo)
        {
            if (id != odontologo.Id)
            {
                return NotFound();
        ...
        {
            return _context.odontologo.Any(e => e.Id == id);
        }
    }
}
