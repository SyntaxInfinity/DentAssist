...
namespace DentAssist.Controllers
{
    public class HistorialTratamientosController : Controller
    {
        ...
        {
            return View(await _context.HistorialTratamiento.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var historialTratamiento = await _context.HistorialTratamiento
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var historialTratamiento = await _context.HistorialTratamiento.FindAsync(id);
            if (historialTratamiento == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (historialTratamiento != null)
            {
                _context.HistorialTratamiento.Remove(historialTratamiento);
            }
        ...
        {
            return _context.HistorialTratamiento.Any(e => e.Id == id);
        }
    }
}
