...
namespace DentAssist.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        {
            return View(await _context.recepciones.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var especialidad = await _context.recepciones
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var especialidad = await _context.recepciones.FindAsync(id);
            if (especialidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (especialidad != null)
            {
                _context.recepciones.Remove(especialidad);
            }
        ...
        {
            return _context.recepciones.Any(e => e.Id == id);
        }
    }
}
